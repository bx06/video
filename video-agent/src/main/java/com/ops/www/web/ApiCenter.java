...
public class ApiCenter {
    ...
    @Autowired
    private void setMapper(PlayManager rtspPlayManager, PlayManager rtmpPlayManager) {
        this.rtspPlayManager = rtspPlayManager;
        this.rtmpPlayManager = rtmpPlayManager;
    }
    ...
    public boolean closeByTheme(@RequestParam Map<String, Object> paramMap) {
        ...
        byte protocol = Byte.parseByte(protocolStr);
        return closeByTheme(clientId, theme, protocol);
    }

    private boolean closeByTheme(String clientId, String theme, byte protocol) {
        switch (protocol) {
            case PlayConfig.PROTOCOL_TRSP:
    ...
    public boolean closeAll() {
        ...
        for (Config2Result config2Result : selectConfig2Result) {
            ...
            closeByTheme(clientId, theme, protocol);
        }
        return true;
    }
